...
public class FlutterWebView implements PlatformView, MethodCallHandler {
  ...
  FlutterWebView(
    ...
    JavaScriptInterface.getBase64StringFromBlobUrl("Test");
  ...
  public void onMethodCall(MethodCall methodCall, Result result) {
    io.flutter.Log.d("created2PRWITHFLUTTER", "Printing lgs");
    Log.d("created2PR", "Printing lgs");
    switch (methodCall.method) {
      ...
      case "getTitle":
        ...
        break;
      case "uploadFilePath":
        uploadFilePath(methodCall, result);
        break;
      default:
  ...
  private void uploadFilePath(MethodCall methodCall, Result result) {
    try {
      ...
      if (Build.VERSION.SDK_INT >= 21) {
        ...
        uriPath.toString();
        mUploadMessage.onReceiveValue(uriPath);
      }
    } catch (Exception e) {
